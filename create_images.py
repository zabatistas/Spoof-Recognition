...
class create_images:
    ...
    def create_train_params(self):
        train_dir = '/home/zabatistas/Desktop/03_SpeakerSpoofing/data/DS_10283_3055/ASVspoof2017_V2_train_fbank'

        filenames = [i for i in os.listdir(train_dir) if i.endswith("100.cmp")]
        train_params=[]
        train_params_value=[]
...
#                print(len(train_params))
    ...
    def create_dev_params(self):
        valid_dir = '/home/zabatistas/Desktop/03_SpeakerSpoofing/data/DS_10283_3055/ASVspoof2017_V2_train_dev'

        filenames = [i for i in os.listdir(valid_dir) if i.endswith("100.cmp")]
        valid_params=[]
        valid_params_value=[]
